...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './registro-de-vacunacion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGISTRODEVACUNACION_LIST actions', async () => {
    ...
    it('dispatches FETCH_REGISTRODEVACUNACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REGISTRODEVACUNACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REGISTRODEVACUNACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REGISTRODEVACUNACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REGISTRODEVACUNACION actions', async () => {
      const expectedActions = [
        {
